  ...
  const EXAM_PREP = [
    {
      ...
      topics: [
        ...
        { id: "kata_pasif",        label: "Kata Pasif",            desc: "Kata kerja pasif — dihantar, dipimpin, dibasuh…",
          catLabels: { kata_kerja_pasif: "Kata kerja pasif" } },
        { id: "kata_hubung",       label: "Kata Hubung",           desc: "dan, tetapi, sambil",
          catLabels: { kata_hubung: "Kata hubung" } },
        { id: "kata_arah",         label: "Kata Arah",             desc: "atas, bawah, luar, dalam, kiri, kanan, hadapan, belakang, sebelah, tepi",
        ...
        { id: "kata_perintah",     label: "Kata Perintah",         desc: "sila, tolong, jangan, minta",
